...
- Last overlay applied: sd_820_wire_compose_suggestion_bar_apply_helper.sh
## Current milestone
...
- **sd_953:** Backend: enable deep reply threading (bounded max depth=25) — removes one-level parent_too_deep restriction in DB + memory reply stores.
...
- **sd_919_post_detail_reply_composer_fb_clean:** Post detail: calm “Replying to …” bar + FB-style inline reply input (remove duplicate mismatch prompts).
