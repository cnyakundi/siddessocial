      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-2xl mx-auto px-4 py-6">
          <div className="rounded-3xl border border-gray-200 bg-white p-6">
            ...
            <div className="text-xs text-gray-500 mt-1">Login to manage your Identity.</div>
            <div className="mt-4">
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-6">
        <div className="mb-4">
          <div className="text-sm font-black text-gray-900">Identity</div>
          <div className="text-xs text-gray-500 mt-1">Edit your Side identities.</div>
        </div>
        ...
        <div className="mt-4 text-xs text-gray-500">
          Tip: Only you can preview Side identities. Everyone else sees the identity your relationship grants.
        </div>
