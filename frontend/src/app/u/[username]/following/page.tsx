      ...
      <div className="px-4 py-4 max-w-[520px] mx-auto">
        {loading ? (
          ...
          <div className="rounded-2xl border border-red-200 bg-red-50 p-4">
            <div className="text-sm font-black text-red-800">Couldn’t load Side With list</div>
          ...
          <div className="text-sm text-gray-500">You aren’t siding with anyone yet.</div>
        )}
