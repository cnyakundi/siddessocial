...
SUMMARY_MD="$OUT_DIR/AUDIT_SUMMARY.md"
{
  ...
  echo ""
  echo "1) If **frontend_typecheck** or **frontend_build** failed, share the ZIP with your dev/debugging assistant."
...
echo "ZIP:    $ZIP_PATH"
echo ""
echo "Share the ZIP with your dev/debugging assistant for a consolidated Broken-Things Register + batch fixes."
echo "=============================="
